package ee.tenman.ester.config;
...
public class CacheConfiguration {
        ...
        log.info("Defining Infinispan Global Configuration");
            if(this.registration == null) { // if registry is not defined, use native discovery
                ...
                return () -> GlobalConfigurationBuilder
                    ...
                    .clusterName("infinispan-ester-cluster").globalJmxStatistics()
    ...
    class InfinispanJCacheManager extends JCacheManager {
        ...
        public InfinispanJCacheManager(URI uri, EmbeddedCacheManager cacheManager, CachingProvider provider,
            ...
            registerPredefinedCache(ee.tenman.ester.domain.User.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.User.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(ee.tenman.ester.domain.Authority.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.Authority.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(ee.tenman.ester.domain.User.class.getName() + ".authorities", new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.User.class.getName() + ".authorities").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(ee.tenman.ester.domain.SocialUserConnection.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.SocialUserConnection.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(ee.tenman.ester.domain.Library.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.Library.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(ee.tenman.ester.domain.Book.class.getName(), new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.Book.class.getName()).getAdvancedCache(), this,
                ConfigurationAdapter.create()));
            registerPredefinedCache(ee.tenman.ester.domain.Book.class.getName() + ".libraries", new JCache<Object, Object>(
                cacheManager.getCache(ee.tenman.ester.domain.Book.class.getName() + ".libraries").getAdvancedCache(), this,
                ConfigurationAdapter.create()));
